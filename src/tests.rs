...
#[tokio::test]
/// Drop in performance after implementing chunking
...
#[tokio::test]
/// The parallel iteration increases performance
async fn test_concurrent_pathspec_line() -> Result<(), Box<dyn std::error::Error>> {
    let start = Instant::now();
